...
pub use model_contracts::{
    ...
    resolve_task_registry_entry, AssetValidationError, BackendHintFact, BackendHintFacts,
    BackendHintLabel, BackendHintSource, CacheGenerationOptions, ComponentState, CustomCodeFacts,
    GenerationDefaultFacts, GenerationOptionResolutionDiagnostic, GenerationOptionResolutionReport,
