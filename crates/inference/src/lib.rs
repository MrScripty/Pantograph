...
pub use model_contracts::{
    ...
    ProcessorComponentKind, PumasArtifactEntryPath, PumasArtifactEntryPathError, PumasModelRef,
    ResolvedArtifactFacts, ResolvedModelPackageFacts, ResolvedModelPackageFactsSummary,
    ResolvedModelSource, ResolvedModelSourceKind, SamplingGenerationOptions,
    SearchGenerationOptions, SpecialTokenGenerationOptions, StoppingGenerationOptions, SupportTier,
    TaskEvidence, TaskExecutionBehavior, TaskFamily, TaskModalitySignature, TaskRegistryEntry,
