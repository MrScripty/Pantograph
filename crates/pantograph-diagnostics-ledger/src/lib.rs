...
pub use event::{
    ...
    MAX_INFERENCE_RESOURCE_OBSERVATION_AVAILABILITY, MAX_INFERENCE_RESOURCE_OBSERVATION_SOURCES,
    MAX_INFERENCE_RUNTIME_SETTINGS, MAX_SCHEDULER_EXECUTION_PLAN_POLICY_TRACE_IDS,
