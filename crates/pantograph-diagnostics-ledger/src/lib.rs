...
pub use event::{
    ...
    IoArtifactProjectionRecord, LibraryAssetAccessedPayload, LibraryUsageProjectionQuery,
    LibraryUsageProjectionRecord, ProjectionStateRecord, ProjectionStateUpdate, ProjectionStatus,
