    ...
    tx.execute(
        "UPDATE run_list_projection
         SET selected_runtime_id = COALESCE(selected_runtime_id, ?1),
             ...
             selected_model_id = COALESCE(?3, selected_model_id),
             selected_task_id = COALESCE(?4, selected_task_id),
             selected_runtime_variant_id = COALESCE(?5, selected_runtime_variant_id),
             selected_device_class = COALESCE(?6, selected_device_class),
             selected_device_id = COALESCE(?7, selected_device_id),
             selected_network_node_id = COALESCE(?8, selected_network_node_id),
             last_event_seq = ?9,
