...
| `node_execution_ledger.rs` | Owns runtime submission of managed model usage facts, inference lifecycle facts, and bounded inference option-support summaries into the durable diagnostics ledger through workflow-service/node-execution boundaries. |
