...
| `embedded_runtime_lifecycle.rs` | Owns embedded-runtime constructors, hosted-composition runtime wrapping, host wiring, dependency-readiness snapshot provider and auto-resume lifecycle composition for standalone services, registry injection, accessors, and shutdown coordination. |
