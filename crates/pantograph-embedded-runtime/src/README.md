...
| `workflow_execution_plan_projection.rs` | Projects workflow-service run execution-plan node decisions into inference `BackendExecutionDecision` contracts at the embedded-runtime composition boundary. |
