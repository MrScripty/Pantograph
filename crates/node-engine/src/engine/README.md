...
| `workflow_session.rs` | Executor-facing workflow-session binding, residency, node-memory inspection/update, and checkpoint-summary helpers that keep the Phase 6 facade wiring out of `engine.rs`. |
