...
impl TaskDescriptor for VisionAnalysisTask {
    fn descriptor() -> TaskMetadata {
        TaskMetadata {
            ...
            inputs: vec![
                PortMetadata::required(Self::PORT_IMAGE, "Image", PortDataType::Image),
                PortMetadata::required(Self::PORT_PROMPT, "Prompt", PortDataType::String),
            ],
