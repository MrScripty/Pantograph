...
| `task_execution_worker.rs` | Internal task-execution worker command, runtime-branch environment, outcome, and diagnostic contracts for backend-owned task-attempt and runtime-branch execution loops. |
