...
- Diagnostics projection tests must verify run-list client/session/bucket and
  workflow execution-session scope facts through public query responses instead
  of raw event inspection.
