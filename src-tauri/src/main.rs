...
use llm::{
    InferenceGateway, RuntimeRegistry, SharedAppConfig, SharedGateway, SharedHealthMonitor,
    SharedRecoveryManager, SharedRuntimeRegistry, cancel_managed_runtime_job,
    ...
    pause_managed_runtime_job, preview_doc_chunks, reclaim_runtime_registry_runtime,
    redo_component_change, refresh_managed_runtime_catalogs, remove_managed_runtime,
...
fn run_app() -> AppStartupResult<()> {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            get_runtime_registry_snapshot,
            get_runtime_debug_snapshot,
            reclaim_runtime_registry_runtime,
            ...
            workflow::commands::workflow_cleanup_stale_sessions,
            ...
            workflow::workflow_execution_tauri_commands::execute_workflow_v2,
            workflow::workflow_execution_tauri_commands::create_workflow_session,
            workflow::workflow_execution_tauri_commands::run_workflow_session,
            workflow::workflow_execution_tauri_commands::get_undo_redo_state,
            workflow::workflow_execution_tauri_commands::undo_workflow,
            workflow::workflow_execution_tauri_commands::redo_workflow,
            workflow::workflow_execution_tauri_commands::update_node_data,
            workflow::workflow_execution_tauri_commands::update_node_position_in_execution,
            workflow::workflow_execution_tauri_commands::add_node_to_execution,
            workflow::workflow_execution_tauri_commands::remove_node_from_execution,
            workflow::workflow_execution_tauri_commands::add_edge_to_execution,
            workflow::workflow_execution_tauri_commands::get_connection_candidates,
            workflow::workflow_execution_tauri_commands::connect_anchors_in_execution,
            workflow::workflow_execution_tauri_commands::insert_node_and_connect_in_execution,
