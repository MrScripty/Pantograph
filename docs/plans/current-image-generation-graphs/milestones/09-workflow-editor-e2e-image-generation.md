...
- The launcher path does not preserve schema `7`.
- It does not bypass the backend attribution crate.
- It does not create a direct model/script execution path.
- It does not infer workflow or artifact state in the frontend.
