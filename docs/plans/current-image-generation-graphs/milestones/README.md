...
**External:** Coding standards, Pumas Library contracts, pinned Pumas
producer-fact completion for scheduler/runtime-host/task orchestration gates,
Python/PyTorch diffusers runtime, and managed llama.cpp runtime artifacts.
