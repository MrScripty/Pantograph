...
- [x] Make the workbench Settings page the canonical persistent settings
  ...
  - [x] Add the workbench Settings page and route ArtifactStore policy plus
    artifact format defaults through typed backend commands and capability
    DTOs.
  ...
  - [x] Relocate, embed, or retire remaining legacy global settings surfaces
