...
SOURCE_ROOTS="${TRACEABILITY_SOURCE_ROOTS:-src,src-tauri/src,crates,packages/svelte-graph/src,scripts}"
ADR_DIR="${ADR_DIR:-docs/adr}"
BASE_REF="${TRACEABILITY_BASE_REF:-origin/main}"
STAGED_ONLY="${TRACEABILITY_STAGED_ONLY:-0}"
HOST_FACING_DIRS="${TRACEABILITY_HOST_FACING_DIRS:-src-tauri/src/llm/commands,src-tauri/src/llm/commands/registry,crates/pantograph-workflow-service,crates/pantograph-workflow-service/src,crates/pantograph-workflow-service/src/workflow,crates/pantograph-workflow-service/tests,crates/pantograph-workflow-service/examples,crates/pantograph-embedded-runtime,crates/pantograph-uniffi,crates/pantograph-uniffi/src,crates/pantograph-rustler,crates/pantograph-rustler/src,crates/pantograph-frontend-http-adapter,crates/inference/torch,crates/inference/depth,crates/inference/audio}"
STRUCTURED_PRODUCER_DIRS="${TRACEABILITY_STRUCTURED_PRODUCER_DIRS:-src/generated,crates/pantograph-workflow-service,crates/pantograph-workflow-service/src,crates/pantograph-workflow-service/src/workflow,crates/pantograph-workflow-service/tests,crates/pantograph-embedded-runtime,crates/pantograph-uniffi,crates/pantograph-uniffi/src,crates/pantograph-rustler,crates/pantograph-rustler/src,crates/inference/torch,crates/inference/depth,crates/inference/audio,crates/inference/src/managed_runtime,crates/inference/src/managed_runtime/llama_cpp_platform,crates/inference/src/managed_runtime/ollama_platform}"
