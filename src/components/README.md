...
the current node validation summary. These overlays are cleared when the graph
revision key changes and are not saved back into graph data or used as submit
authority.
