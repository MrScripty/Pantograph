...
test('getWorkflowMiniMapNodeColor prioritizes group nodes', () => {
...
test('getWorkflowMiniMapNodeColor maps backend categories to stable colors', () => {
...
test('getWorkflowMiniMapNodeColor falls back for unknown nodes', () => {
