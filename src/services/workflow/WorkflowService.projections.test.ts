...
test('queryRunList preserves backend projection rows and facets', async () => {
  ...
  const response: WorkflowRunListQueryResponse = {
    runs: [
      {
        ...
        model_cache_state: 'cache_miss',
        scheduler_reason: 'waiting_for_runtime_admission',
        latest_error_event_id: 'error-event-a',
        ...
        fatal_error_event_id: 'error-event-a',
        error_count: 1,
        warning_count: 0,
        last_event_seq: 5,
    ...
    facets: [
      ...
      { facet_kind: 'selected_runtime', facet_value: 'runtime-a', run_count: 1 },
    ],
    projection_state: {
